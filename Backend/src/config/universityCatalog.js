...
export const UNIVERSITY_CATALOG_RD = [
  // ═══ REPÚBLICA DOMINICANA ═══
  {
    ...
    games: ['Valorant', 'League of Legends', 'Mobile Legends', 'Wild Rift'],
    offers: ['Becas deportivas de esports', 'Centro de entrenamiento gaming', 'Torneos interuniversitarios', 'Club oficial de esports'],
    teams: [
      { name: 'UASD Gaming (MLBB)', game: 'Mobile Legends', members: 5, rank: 'Campeon Copa Popular 2025' },
  ...
  },
  {
    ...
    games: ['Valorant', 'League of Legends', 'Mobile Legends'],
  ...
  },
  {
    ...
    teams: [
      ...
      { name: 'INTEC Rift', game: 'League of Legends', members: 5, rank: 'Platinum' },
    ],
  },
  {
    ...
    teams: [
      { name: 'UNIBE eSports (EA FC)', game: 'Mobile Legends', members: 5, rank: 'Campeon EA FC Copa Popular 2025' },
  ...
  },
  {
    ...
    teams: [
      { name: 'ITLA eSports (LoL)', game: 'League of Legends', members: 5, rank: 'Campeon Copa Popular 2025' },
      { name: 'ITLA eSports (Valorant)', game: 'Valorant', members: 5, rank: 'Campeon Copa Popular 2025' },
      { name: 'ITLA eSports (MLBB)', game: 'Mobile Legends', members: 5, rank: '3er lugar Copa Popular 2025' },
  ...
  },
  {
    ...
    teams: [
      ...
      { name: 'APEC Legends', game: 'Mobile Legends', members: 5, rank: 'Mythic' },
    ],
  },
  {
    ...
    teams: [
      ...
      { name: 'UNPHU Rift', game: 'League of Legends', members: 5, rank: 'Gold' },
    ],
  },
  {
    ...
    teams: [
      ...
      { name: 'UTESA Mobile', game: 'Mobile Legends', members: 5, rank: 'Legend' },
    ],
  },
  {
