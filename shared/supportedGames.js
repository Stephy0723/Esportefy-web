...
const BASE_SUPPORTED_GAMES = [
  ...
  },
  {
    ...
    short: 'CS2',
    categories: ['FPS'],
    aliases: ['cs2', 'counter strike 2', 'counter-strike 2', 'counter strike2', 'counterstrike 2'],
    roles: ['IGL', 'Entry', 'AWPer', 'Support', 'Lurker'],
  },
  {
    id: 'ow2',
    name: 'Overwatch 2',
    short: 'OW2',
    categories: ['FPS'],
    aliases: ['overwatch 2', 'overwatch', 'ow2'],
    roles: ['Tank', 'DPS', 'Support', 'Flex', 'IGL'],
  },
  {
    id: 'dota2',
    name: 'Dota 2',
  ...
  },
  {
    ...
    short: 'NBA 2K',
    categories: ['Sports'],
    aliases: ['nba 2k24', 'nba2k24', 'nba2k'],
    roles: ['Player'],
  },
  {
    id: 'smash',
  ...
  },
  {
    ...
    short: 'R6',
    categories: ['FPS'],
    aliases: ['rainbow six siege', 'rainbow six', 'r6', 'r6s', 'siege'],
  ...
  },
  {
    ...
    roles: ['Slayer', 'Objective', 'Support', 'Flex'],
  },
  {
    id: 'cr',
    name: 'Clash Royale',
    short: 'CR',
    categories: ['Strategy'],
    aliases: ['clash royale', 'clashroyale', 'cr'],
    roles: ['Player'],
  },
  {
    id: 'hs',
