...
const GAME_POLICY_OVERRIDES = Object.freeze({
  ...
  ow2: {
    teamSize: 5,
    maxSubs: 2,
    tournamentPlatforms: ['PC', 'Console', 'Crossplay'],
    defaultPlatform: 'PC',
    tournamentModalities: ['5v5'],
    defaultModality: '5v5',
    tournamentSeries: ['BO3', 'BO5'],
    defaultSeries: 'BO5',
    tournamentServers: [
      { value: 'LATAM', label: 'LATAM' },
      { value: 'NA', label: 'Norteamerica (NA)' },
  ...
  dota2: {
    ...
    tournamentMaps: ['The Ancient'],
    tournamentColor: '#e33935',
    tournamentIcon: 'bx-shield-quarter',
    tournamentCategory: 'MOBA',
  },
  mlbb: {
    teamSize: 5,
  ...
  apex: {
    ...
    tournamentMaps: ["World's Edge", 'Storm Point', 'Broken Moon', 'E-District'],
    tournamentColor: '#cd3333',
    tournamentIcon: 'bx-target-lock',
    tournamentCategory: 'BR',
  },
  warzone: {
  ...
  nba2k: {
    ...
    tournamentIcon: 'bx-basketball',
    tournamentCategory: 'Sports',
  },
  smash: {
    teamSize: 2,
    maxSubs: 1,
    teamSummary: 'Roster flexible para singles o doubles, con duo titular y apoyo de coaching/corner.',
    teamTips: [
      'Puedes operar el mismo equipo para brackets 1v1 o 2v2 sin rehacer identidad.',
      'En doubles define chemistry, order calls y stage comfort desde los tryouts.',
      'Usa el suplente como backup para pools largas o cambios de disponibilidad.',
    ],
    teamStaffLabel: 'Coach / Corner',
    tournamentPlatforms: ['Console'],
    defaultPlatform: 'Console',
    tournamentModalities: ['1v1', '2v2'],
    defaultModality: '1v1',
    tournamentSeries: ['FT2', 'FT3', 'BO5'],
    defaultSeries: 'FT2',
    tournamentSummary: 'Preset competitivo para singles o doubles con soporte de bracket clásico y doble eliminación.',
    tournamentTips: [
      'Aclara si el evento es singles o doubles en el título y reglamento.',
      'Para doubles deja claro team attack, coach policy y stage procedure.',
      'Top cut en doble eliminación funciona especialmente bien para FGC local o invitacional.',
    ],
    tournamentServers: [
  ...
  brawlhalla: {
    teamSize: 2,
    maxSubs: 1,
    teamSummary: 'Roster flexible para duelistas 1v1 o parejas 2v2 con foco en sinergia, backup y lectura de matchups.',
    teamTips: [
      'Usa el mismo team shell para singles o doubles sin perder continuidad competitiva.',
      'Define main legend, armas y sinergia de pareja antes de abrir reclutamiento.',
    ...
    tournamentSeries: ['FT2', 'FT3', 'BO5'],
    defaultSeries: 'FT2',
    tournamentSummary: 'Preset para 1v1 o 2v2 con FT2 base y opción de doble eliminación para eventos FGC/community.',
    tournamentTips: [
      'Aclara stages legales, strike y side selection en el reglamento.',
      'Si es 2v2, documenta si hay team damage, lobby host y resolución de desconexiones.',
  ...
  r6: {
    teamSize: 5,
    maxSubs: 2,
    tournamentPlatforms: ['PC', 'Console'],
    defaultPlatform: 'PC',
    tournamentModalities: ['5v5'],
    defaultModality: '5v5',
    tournamentSeries: ['BO1', 'BO3', 'BO5'],
  ...
  cr: {
    ...
    tournamentMaps: ['Arena'],
    tournamentColor: '#3b82f6',
    tournamentIcon: 'bx-chess',
    tournamentCategory: 'Strategy',
  },
  hs: {
    teamSize: 1,
    maxSubs: 1,
    tournamentPlatforms: ['PC', 'Mobile', 'Crossplay'],
    defaultPlatform: 'Crossplay',
    tournamentModalities: ['1v1'],
    defaultModality: '1v1',
    tournamentSeries: ['BO1', 'BO3', 'BO5'],
    ...
    tournamentMaps: ['Conquest', 'Last Hero Standing'],
    tournamentColor: '#22c55e',
    tournamentIcon: 'bx-chess',
    tournamentCategory: 'Strategy',
  },
