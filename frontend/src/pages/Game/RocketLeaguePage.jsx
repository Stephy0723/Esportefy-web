...
const RocketLeaguePage = () => {
    ...
    const data = gamesDetailedData?.rocketleague;

    if (!data) return null;

    return (
        /* La clase theme-rocketleague activa el color celeste en el CSS */
        <div className="game-page-premium theme-rocketleague">
            
            <div className="background-hero" style={{ backgroundImage: `url(${BannerRocketLeague})` }}>
