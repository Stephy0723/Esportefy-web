...
const StarcraftPage = () => {
    ...
    const data = gamesDetailedData?.starcraft;

    if (!data) return <div style={{color: 'white', padding: '100px'}}>Cargando Starcraft...</div>;

    return (
        <div className="game-page-premium theme-starcraft">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerStarcraft})` }}>
