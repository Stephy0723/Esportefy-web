...
import bannerML from '../../assets/banner/BannerMLBB.jpg'; 
import './GamePageIndividual.css';

const MobileLegendsPage = () => {
    const navigate = useNavigate();
    const data = gamesDetailedData?.mlbb;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-mlbb">
            <div className="background-hero" style={{ backgroundImage: `url(${bannerML})` }}>
