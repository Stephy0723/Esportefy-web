...
const PubgMobilePage = () => {
    const navigate = useNavigate();
    const data = gamesDetailedData?.pubg;

    if (!data) return null;

    return (
        /* La clase theme-pubg activa el color dorado desierto en el CSS */
        <div className="game-page-premium theme-pubg">
            
            <div className="background-hero" style={{ backgroundImage: `url(${BannerPubg})` }}>
