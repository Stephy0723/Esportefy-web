...
const OverwatchPage = () => {
    ...
    const data = gamesDetailedData?.overwatch;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-overwatch">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerOverwatch})` }}>
