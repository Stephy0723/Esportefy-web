...
const HearthstonePage = () => {
    ...
    const data = gamesDetailedData?.hearthstone;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-hearthstone">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerHearthstone})` }}>
