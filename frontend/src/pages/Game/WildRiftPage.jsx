...
import bannerWR from '../../assets/banner/BannerWild.jpg'; 
import './GamePageIndividual.css';

const WildRiftPage = () => {
    const navigate = useNavigate();
    const data = gamesDetailedData?.wildrift;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-wildrift">
            <div className="background-hero" style={{ backgroundImage: `url(${bannerWR})` }}>
