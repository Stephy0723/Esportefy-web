...
const LeagueOfLegendsPage = () => {
    ...
    const data = gamesDetailedData?.lol;

    if (!data) return null;

    return (
        /* Quitamos el estado manual. La clase se controla globalmente */
        <div className={`game-page-premium theme-${data.id}`}>
            
            <div className="background-hero" style={{ backgroundImage: `url(${bannerLol})` }}>
