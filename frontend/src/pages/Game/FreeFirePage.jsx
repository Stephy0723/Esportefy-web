...
const FreeFirePage = () => {
    ...
    const data = gamesDetailedData?.freefire;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-freefire">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerFreefire})` }}>
