...
const CsgoPage = () => {
    ...
    const data = gamesDetailedData?.csgo;

    if (!data) return <div style={{color: 'white', padding: '100px'}}>Cargando Counter-Strike...</div>;

    return (
        /* La clase theme-csgo activa el color naranja óxido en el CSS */
        <div className="game-page-premium theme-csgo">
            
            <div className="background-hero" style={{ backgroundImage: `url(${BannerCsgo})` }}>
            ...
            <main className="content-overlay">
                ...
                <div className="game-details-grid">
                    ...
                    {/* COLUMNA IZQUIERDA: HISTORIA Y PATROCINADORES */}
