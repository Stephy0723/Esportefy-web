...
const ApexPage = () => {
    ...
    const data = gamesDetailedData?.apex;

    if (!data) return null;

    return (
        /* La clase theme-apex aplica el rojo característico en el CSS */
        <div className="game-page-premium theme-apex">
            
            <div className="background-hero" style={{ backgroundImage: `url(${BannerApex})` }}>
            ...
            <main className="content-overlay">
                ...
                <div className="game-details-grid">
                    ...
                    {/* COLUMNA IZQUIERDA: HISTORIA Y SPONSORS */}
