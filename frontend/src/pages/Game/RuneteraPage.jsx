...
const RuneterraPage = () => {
    ...
    const data = gamesDetailedData?.runeterra;

    if (!data) return <div className="loading-state">Invocando campeones...</div>;

    return (
        <div className="game-page-premium theme-runeterra">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerRuneterra})` }}>
