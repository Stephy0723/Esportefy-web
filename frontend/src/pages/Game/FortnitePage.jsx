...
const FortnitePage = () => {
    ...
    const data = gamesDetailedData?.fortnite;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-fortnite">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerFortnite})` }}>
