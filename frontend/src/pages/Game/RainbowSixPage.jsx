...
const RainbowSixPage = () => {
    ...
    const data = gamesDetailedData?.rainbowsix;

    if (!data) return null;

    return (
        <div className="game-page-premium theme-rainbowsix">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerRainbowSix})` }}>
