...
const Nba2k14Page = () => {
    ...
    const data = gamesDetailedData?.nba2k14;

    if (!data) return <div className="loading-state">Calentando en la duela...</div>;

    return (
        <div className="game-page-premium theme-nba2k14">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerNba2k14})` }}>
