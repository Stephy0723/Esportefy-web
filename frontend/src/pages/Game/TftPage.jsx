...
const TftPage = () => {
    ...
    const data = gamesDetailedData?.tft;

    if (!data) return <div style={{color: 'white', padding: '100px'}}>Cargando TFT...</div>;

    return (
        <div className="game-page-premium theme-tft">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerTft})` }}>
