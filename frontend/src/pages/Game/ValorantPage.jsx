...
const ValorantPage = () => {
    ...
    const data = gamesDetailedData?.valorant;

    if (!data) return null;

    return (
        <div className={`game-page-premium theme-valorant`}>
            <div className="background-hero" style={{ backgroundImage: `url(${bannerValorant})` }}>
