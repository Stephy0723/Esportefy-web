...
const ClashRoyalePage = () => {
    ...
    const data = gamesDetailedData?.clashroyale;

    if (!data) return <div style={{color: 'white', padding: '100px'}}>Cargando Arena...</div>;

    return (
        <div className="game-page-premium theme-clashroyale">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerClashRoyale})` }}>
