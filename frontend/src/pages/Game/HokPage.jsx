...
const HokPage = () => {
    ...
    const data = gamesDetailedData?.hok;

    if (!data) return null;

    return (
        /* La clase theme-hok activa el color oro imperial en el CSS */
        <div className="game-page-premium theme-hok">
            
            <div className="background-hero" style={{ backgroundImage: `url(${BannerHok})` }}>
            ...
            <main className="content-overlay">
                ...
                <div className="game-details-grid">
                    ...
                    {/* COLUMNA DERECHA: SIDEBAR (ORGANIZADORES Y COMUNIDADES) */}
