...
const Tekken8Page = () => {
    ...
    // Accedemos a los datos usando el ID 'tekken8'
    const data = gamesDetailedData?.tekken8;

    if (!data) return <div className="loading-state">Despertando el Gen Diabólico...</div>;

    return (
        /* Clase 'theme-tekken8' para aplicar los estilos de color rojo */
        <div className="game-page-premium theme-tekken8">
            <div className="background-hero" style={{ backgroundImage: `url(${BannerTekken8})` }}>
