...
const CasterPage = () => {
    ...
    const handleGameToggle = (game) => {
        setSelectedGames(prev => {
            const updated = prev.includes(game) ? prev.filter(g => g !== game) : [...prev, game];
            return updated;
        });
    ...
    const validate = () => {
        ...
        if (!selectedGames.length) errors.games = 'Selecciona al menos un juego que narras.';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            notify('success', t('roleApplySuccess'), 'Tu solicitud de Caster fue enviada y quedó pendiente de confirmación.');
            navigate('/profile');
        } catch (err) {
                ...
                <div className="split-layout">
                    <div className="form-side">
                        ...
                        <form className="gamer-form" onSubmit={handleSubmit} noValidate>
                            ...
                            <div className="input-group">
                                <label className="static-label">Juegos que narras <span style={{color:'#ef4444'}}>*</span></label>
