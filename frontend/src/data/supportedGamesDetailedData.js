...
const supportedGamesDetailedData = {
  lol: {
    ...
    history:
      'League of Legends es el MOBA competitivo central de Esportefy. Su ecosistema combina estrategia por líneas, control de objetivos y juego coordinado de alto nivel.',
    ...
    organizers: [
      ...
      { name: 'Esportefy', motto: 'Comunidad y torneos para nuevos equipos' },
    ],
    ...
    userCommunities: [
      ...
      { name: 'Esportefy LoL Hub', members: '9k' },
    ],
    tournaments: [
  ...
  valorant: {
    ...
    developer: 'Riot Games',
    history:
      'Valorant es el shooter tactico soportado por Esportefy. Mezcla precision, utilidad y lectura de rondas dentro de un ecosistema competitivo estructurado.',
  ...
  mlbb: {
    ...
    developer: 'Moonton',
    history:
      'Mobile Legends es el MOBA movil soportado por Esportefy para equipos, torneos y vinculacion interna de cuenta. La plataforma trabaja con User ID + Zone ID para sincronizacion operativa.',
