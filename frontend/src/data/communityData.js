...
export const COMMUNITY_GAMES = [
  { name: 'Valorant', id: 'valorant', img: ValorantImg, color: '#ff4655', cat: 'FPS', players: '35.2k', url: 'https://playvalorant.com' },
  { name: 'League of Legends', id: 'lol', img: LoLImg, color: '#0ac8b9', cat: 'MOBA', players: '48.1k', url: 'https://www.leagueoflegends.com' },
  { name: 'CS2', id: 'cs2', img: CS2Img, color: '#de9b35', cat: 'FPS', players: '29.7k', url: 'https://www.counter-strike.net' },
  { name: 'Fortnite', id: 'fortnite', img: FortniteImg, color: '#22c55e', cat: 'BR', players: '41.3k', url: 'https://www.fortnite.com' },
  { name: 'Warzone', id: 'warzone', img: WarzoneImg, color: '#4caf50', cat: 'BR', players: '22.8k', url: 'https://www.callofduty.com/warzone' },
  { name: 'Overwatch 2', id: 'ow2', img: OW2Img, color: '#f99e1a', cat: 'FPS', players: '18.5k', url: 'https://overwatch.blizzard.com' },
  { name: 'Dota 2', id: 'dota2', img: Dota2Img, color: '#e33935', cat: 'MOBA', players: '15.9k', url: 'https://www.dota2.com' },
  { name: 'Hearthstone', id: 'hs', img: HSImg, color: '#22c55e', cat: 'Strategy', players: '9.8k', url: 'https://hearthstone.blizzard.com' },
  { name: 'Legends of Runeterra', id: 'lor', img: LoRImg, color: '#16a34a', cat: 'Strategy', players: '6.3k', url: 'https://playruneterra.com' },
  { name: 'Rocket League', id: 'rl', img: RLImg, color: '#0088ff', cat: 'Sports', players: '12.3k', url: 'https://www.rocketleague.com' },
  { name: 'Apex Legends', id: 'apex', img: ApexImg, color: '#cd3333', cat: 'BR', players: '19.4k', url: 'https://www.ea.com/games/apex-legends' },
  { name: 'PUBG Mobile', id: 'pubgm', img: PUBGMImg, color: '#f2a93b', cat: 'BR', players: '14.1k', url: 'https://www.pubgmobile.com' },
  { name: 'Rainbow Six Siege', id: 'r6', img: R6SImg, color: '#ff8c00', cat: 'FPS', players: '11.2k', url: 'https://www.ubisoft.com/en-us/game/rainbow-six/siege' },
  { name: 'Street Fighter 6', id: 'sf6', img: SF6Img, color: '#ff5e00', cat: 'Fighting', players: '8.7k', url: 'https://www.streetfighter.com/6' },
  { name: 'Tekken 8', id: 'tekken8', img: Tekken8Img, color: '#ffd700', cat: 'Fighting', players: '9.1k', url: 'https://www.bandainamcoent.com/games/tekken-8' },
  { name: 'Mobile Legends', id: 'mlbb', img: MLBBImg, color: '#00d2ff', cat: 'MOBA', players: '26.4k', url: 'https://www.mobilelegends.com' },
  { name: 'Free Fire', id: 'ff', img: FFImg, color: '#ffaa00', cat: 'BR', players: '31.6k', url: 'https://ff.garena.com' },
  { name: 'Clash Royale', id: 'cr', img: CRImg, color: '#3b82f6', cat: 'Strategy', players: '10.5k', url: 'https://supercell.com/en/games/clashroyale' },
  { name: 'Arena of Valor', id: 'aov', img: AOVImg, color: '#10b981', cat: 'MOBA', players: '11.9k', url: 'https://www.arenaofvalor.com' },
  { name: 'Honor of Kings', id: 'hok', img: HoKImg, color: '#eab308', cat: 'MOBA', players: '45.2k', url: 'https://www.honorofkings.com' },
  { name: 'TFT', id: 'tft', img: TFTImg, color: '#16a34a', cat: 'Strategy', players: '7.8k', url: 'https://teamfighttactics.leagueoflegends.com' },
  { name: 'Wild Rift', id: 'wildrift', img: WildRiftImg, color: '#22d3ee', cat: 'MOBA', players: '16.9k', url: 'https://wildrift.leagueoflegends.com' },
  { name: 'StarCraft II', id: 'starcraft', img: SC2Img, color: '#1d4ed8', cat: 'Strategy', players: '8.2k', url: 'https://starcraft2.blizzard.com' },
  { name: 'NBA 2K24', id: 'nba2k', img: NBA2K24Img, color: '#f59e0b', cat: 'Sports', players: '10.2k', url: 'https://nba.2k.com' },
  { name: 'GTA V', id: 'gta', img: GTAImg, color: '#15803d', cat: 'RPG', players: '20.1k', url: 'https://www.rockstargames.com/gta-v' },
  { name: 'Genshin Impact', id: 'genshin', img: GenshinImg, color: '#14b8a6', cat: 'RPG', players: '24.8k', url: 'https://genshin.hoyoverse.com' },
  { name: 'Mario Kart', id: 'mariokart', img: MarioKartImg, color: '#22c55e', cat: 'Sports', players: '13.6k', url: 'https://mariokart.nintendo.com' },
  { name: 'Halo Infinite', id: 'halo', img: HaloImg, color: '#0ea5e9', cat: 'FPS', players: '9.7k', url: 'https://www.halowaypoint.com/halo-infinite' },
  { name: 'Among Us', id: 'amongus', img: AmongUsImg, color: '#16a34a', cat: 'Social', players: '7.5k', url: 'https://www.innersloth.com/games/among-us' },
  { name: 'Fall Guys', id: 'fallguys', img: FallGuysImg, color: '#22c55e', cat: 'Social', players: '6.4k', url: 'https://www.fallguys.com' },
  { name: 'Wuthering Waves', id: 'wuwa', img: WuwaImg, color: '#10b981', cat: 'RPG', players: '8.9k', url: 'https://wutheringwaves.kurogames.com' },
  { name: 'Marvel Rivals', id: 'marvel', img: 'https://cdn.akamai.steamstatic.com/steam/apps/2767030/header.jpg', color: '#ef4444', cat: 'FPS', players: '27.8k', url: 'https://www.marvelrivals.com' },
  { name: 'XDefiant', id: 'xdefiant', img: 'https://cdn.akamai.steamstatic.com/steam/apps/2434700/header.jpg', color: '#f97316', cat: 'FPS', players: '13.1k', url: 'https://www.ubisoft.com/en-us/game/xdefiant' },
  { name: 'The Finals', id: 'thefinals', img: 'https://cdn.akamai.steamstatic.com/steam/apps/2073850/header.jpg', color: '#e11d48', cat: 'FPS', players: '16.4k', url: 'https://www.reachthefinals.com' },
  { name: 'Escape From Tarkov', id: 'tarkov', img: 'https://images.ctfassets.net/pvgyxhxq7n13/6PRfN5Bfc2fNqppM8oaYwN/0a1f092f8e8fd3e26d61f5f64f2f95de/eft_share.jpg', color: '#84cc16', cat: 'FPS', players: '11.7k', url: 'https://www.escapefromtarkov.com' },
  { name: 'Deadlock', id: 'deadlock', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1422450/header.jpg', color: '#8b5cf6', cat: 'MOBA', players: '22.1k', url: 'https://store.steampowered.com/app/1422450/Deadlock' },
  { name: 'EA FC 25', id: 'eafc25', img: 'https://cdn.akamai.steamstatic.com/steam/apps/2669320/header.jpg', color: '#22c55e', cat: 'Sports', players: '18.9k', url: 'https://www.ea.com/games/ea-sports-fc/fc-25' },
  { name: 'Dragon Ball Sparking Zero', id: 'dbsz', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1790600/header.jpg', color: '#f59e0b', cat: 'Fighting', players: '21.5k', url: 'https://en.bandainamcoent.eu/dragon-ball/dragon-ball-sparking-zero' },
  { name: 'MultiVersus', id: 'multiversus', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1818750/header.jpg', color: '#3b82f6', cat: 'Fighting', players: '14.2k', url: 'https://multiversus.com' },
  { name: 'Palworld', id: 'palworld', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1623730/header.jpg', color: '#10b981', cat: 'RPG', players: '19.6k', url: 'https://www.pocketpair.jp/palworld' },
  { name: 'Helldivers 2', id: 'helldivers2', img: 'https://cdn.akamai.steamstatic.com/steam/apps/553850/header.jpg', color: '#facc15', cat: 'FPS', players: '25.4k', url: 'https://www.playstation.com/games/helldivers-2' },
  { name: 'Baldur Gate 3', id: 'bg3', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1086940/header.jpg', color: '#f59e0b', cat: 'RPG', players: '28.7k', url: 'https://baldursgate3.game' },
  { name: 'Call of Duty BO6', id: 'codbo6', img: 'https://cdn.akamai.steamstatic.com/steam/apps/2933620/header.jpg', color: '#f97316', cat: 'FPS', players: '31.2k', url: 'https://www.callofduty.com/blackops6' },
  { name: 'Mortal Kombat 1', id: 'mk1', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1971870/header.jpg', color: '#dc2626', cat: 'Fighting', players: '11.3k', url: 'https://www.mortalkombat.com' },
  { name: 'Elden Ring', id: 'eldenring', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1245620/header.jpg', color: '#d4a017', cat: 'RPG', players: '22.3k', url: 'https://www.eldenring.jp' },
  { name: 'Cyberpunk 2077', id: 'cyberpunk', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1091500/header.jpg', color: '#fbbf24', cat: 'RPG', players: '19.8k', url: 'https://www.cyberpunk.net' },
  { name: 'Red Dead Redemption 2', id: 'rdr2', img: 'https://cdn.akamai.steamstatic.com/steam/apps/1174180/header.jpg', color: '#b91c1c', cat: 'RPG', players: '17.4k', url: 'https://www.rockstargames.com/reddeadredemption2' },
  { name: 'Monster Hunter Wilds', id: 'mhwilds', img: 'https://cdn.akamai.steamstatic.com/steam/apps/2246340/header.jpg', color: '#059669', cat: 'RPG', players: '26.1k', url: 'https://www.monsterhunter.com/wilds' },
  { name: 'Hogwarts Legacy', id: 'hogwarts', img: 'https://cdn.akamai.steamstatic.com/steam/apps/990080/header.jpg', color: '#7c3aed', cat: 'RPG', players: '15.2k', url: 'https://www.hogwartslegacy.com' },
  { name: 'No Mans Sky', id: 'nms', img: 'https://cdn.akamai.steamstatic.com/steam/apps/275850/header.jpg', color: '#0891b2', cat: 'RPG', players: '11.8k', url: 'https://www.nomanssky.com' }
];
